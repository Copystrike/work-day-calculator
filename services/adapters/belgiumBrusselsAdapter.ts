...
export class BelgiumBrusselsAdapter implements RegionAdapter {
  id = 'BE-BRU';
  name = 'België (Brussel)';
  description = 'Inclusief Belgische nationale feestdagen en het Feest van de Iris (8 mei).';
  ...
  getPublicHolidays(year: number): Holiday[] {
    ...
    holidays.push({ date: `${year}-05-08`, name: "Feest van de Iris", type: 'regional' });
...
export const belgiumBrusselsAdapter = new BelgiumBrusselsAdapter();