...
export class BelgiumWalloniaAdapter implements RegionAdapter {
  id = 'BE-WAL';
  name = 'België (Wallonië)';
  description = 'Inclusief Belgische nationale feestdagen en het Feest van de Franse Gemeenschap (27 september).';
  ...
  getPublicHolidays(year: number): Holiday[] {
    ...
    holidays.push({ date: `${year}-09-27`, name: "Feest van de Franse Gemeenschap", type: 'regional' });
...
export const belgiumWalloniaAdapter = new BelgiumWalloniaAdapter();